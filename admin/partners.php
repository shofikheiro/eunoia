...
<section class="adminhome">
    ...
    if ($op == 'delete') {
        ...
        $q1     = mysqli_query($koneksi, $sql1);
        if ($q1) {
            $sukses     = "Deleting Data Success!";
        }
    }
    ?>
    <h1>Partners Admin Page</h1>
    <p>
        <a href="partners_input.php">
            <input type="button" class="btn btn-primary" value="Input a New Partner" />
        </a>
    </p>
    <?php
    if ($sukses) {
            ...
            ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="partners.php?op=delete&id=<?php echo $r1['id'] ?>" onclick="return confirm('Are you sure to delete this?')">
